---
name: product-launcher:launch-materials
description: Use when launching a product and need coordinated GTM materials (subscriber email, CEO blog post, CEO tweet thread). Triggers on "launch", "announce", "email subscribers", "tweet thread", "GTM".
license: MIT
---
